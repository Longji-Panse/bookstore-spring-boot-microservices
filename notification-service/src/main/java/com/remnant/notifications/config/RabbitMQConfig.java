package com.remnant.notifications.config;
...
public class RabbitMQConfig {
    ...
    public RabbitMQConfig(ApplicationProperties properties, Environment env) {
    ...
    public void logConnectionInfo() {
        System.out.println("Connecting to RabbitMQ at host: " + env.getProperty("spring.rabbitmq.host"));
    }
}
